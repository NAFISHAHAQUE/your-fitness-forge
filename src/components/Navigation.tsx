...
export const Navigation = ({ activeTab, onTabChange }: NavigationProps) => {
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-40 border-t border-border bg-card/95 backdrop-blur-xl md:relative md:border-t-0 md:border-r md:bg-transparent">
      <div className="flex justify-around md:flex-col md:gap-1 md:p-3">
        {navItems.map(item => {
          ...
          return (
            <button
              ...
              className={cn(
                "group flex flex-col items-center gap-1 px-4 py-3 transition-all duration-200 md:flex-row md:gap-3 md:rounded-lg md:px-4 md:py-3",
                isActive
